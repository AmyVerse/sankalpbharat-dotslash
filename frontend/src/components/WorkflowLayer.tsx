  ...
  return (
    <div className="h-full bg-[#fcf9f4] p-10 flex flex-col gap-10 overflow-y-auto custom-scrollbar">
      <header className="flex justify-between items-end">
        <div>
          <span className="text-[10px] text-[#974726] font-bold uppercase tracking-[0.2em] mb-1 block">Collaborative Workspace</span>
          <h2 className="text-3xl font-bold newsreader text-[#553a34]">Internal Directive Workflow</h2>
        </div>
        <div className="flex gap-4">
          <button className="px-6 py-3 bg-white border border-[#dac2b6] text-[10px] font-bold uppercase tracking-wider text-[#553a34] rounded-sm hover:bg-[#ebe8e3] transition-all">
             Invite Auditors
          </button>
          <button className="px-6 py-3 bg-[#553a34] text-white text-[10px] font-bold uppercase tracking-wider rounded-sm hover:bg-[#3a2824] transition-all">
             New Action Request
          </button>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 flex flex-col gap-6">
          <h3 className="text-[10px] font-bold tracking-[0.2em] text-[#877369] uppercase border-b border-[#dac2b6] border-opacity-30 pb-4">Active Tasks</h3>
              ...
              <div key={item.id} className="editorial-card bg-white p-6 flex items-center justify-between group hover:border-[#974726] transition-all">
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex flex-col gap-1">
                    <span className="text-xs font-bold text-[#877369] uppercase tracking-wider">{item.dept} // {item.type}</span>
                    <h4 className="text-sm font-bold text-[#553a34] newsreader">{item.description}</h4>
                  </div>
                </div>
                <div className="flex items-center gap-8">
                   <div className="flex flex-col items-end">
                      <span className="text-[9px] font-bold uppercase text-[#877369]">Priority</span>
        ...
        <div className="flex flex-col gap-8">
           <div className="bg-[#ebe8e3] p-8 border border-[#dac2b6] border-opacity-40 rounded-sm">
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-[#553a34] mb-6">Departmental Health</h4>
              <div className="space-y-6">
                 {[
                   ...
                   <div key={dept.label} className="space-y-2">
                      <div className="flex justify-between text-[10px] font-bold uppercase text-[#877369]">
           ...
           <div className="editorial-card p-8 bg-white border-l-4 border-[#974726]">
              <div className="flex items-center gap-3 mb-4">
                 ...
                 <h4 className="text-sm font-bold text-[#553a34] uppercase tracking-wider">Compliance Warning</h4>
              </div>
